...
module Lotus
  ...
  class Configuration
    ...
    #   Bookshelf::Application.configuration.security.content_policy_security # => "connect-src 'self'; script-src 'self';"
    #
    ...
    #   Bookshelf::Application.configuration.security.content_policy_security "script-src 'self' https://apis.google.com"
    def security
